...
class Version20200520234018 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE customers (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) DEFAULT NULL, uuid VARCHAR(255) DEFAULT NULL, age INT DEFAULT NULL, dni VARCHAR(255) DEFAULT NULL, birthdate DATETIME DEFAULT NULL, postal_code VARCHAR(255) DEFAULT NULL, country VARCHAR(255) DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, vatCondition VARCHAR(255) DEFAULT NULL, taxationKey VARCHAR(255) DEFAULT NULL, grossIncome VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
