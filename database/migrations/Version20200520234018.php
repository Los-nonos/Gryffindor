...
class Version20200520234018 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE `product_purchase_order` (`product_id` int NOT NULL, `purchase_order_id` int NOT NULL, PRIMARY KEY (`product_id`,`purchase_order_id`), KEY `IDX_25237124584665A` (`product_id`), KEY `IDX_2523712E20D463C` (`purchase_order_id`), CONSTRAINT `FK_25237124584665A` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE, CONSTRAINT `FK_2523712E20D463C` FOREIGN KEY (`purchase_order_id`) REFERENCES `purchase_orders` (`id`) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;');
