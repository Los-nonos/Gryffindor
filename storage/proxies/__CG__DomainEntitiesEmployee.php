 ...
 */
class Employee extends \Domain\Entities\Employee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Domain\\Entities\\Employee' . "\0" . 'id', '' . "\0" . 'Domain\\Entities\\Employee' . "\0" . 'role', '' . "\0" . 'Domain\\Entities\\Employee' . "\0" . 'orders'];
        }
