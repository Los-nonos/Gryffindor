 ...
 */
class Characteristic extends \Domain\Entities\Characteristic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Domain\\Entities\\Characteristic' . "\0" . 'id', '' . "\0" . 'Domain\\Entities\\Characteristic' . "\0" . 'name', '' . "\0" . 'Domain\\Entities\\Characteristic' . "\0" . 'property', '' . "\0" . 'Domain\\Entities\\Characteristic' . "\0" . 'product'];
        }
