 ...
 */
class FilterOption extends \Domain\Entities\FilterOption implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Domain\\Entities\\FilterOption' . "\0" . 'id', '' . "\0" . 'Domain\\Entities\\FilterOption' . "\0" . 'name', '' . "\0" . 'Domain\\Entities\\FilterOption' . "\0" . 'filter'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FilterOption $proxy) {
